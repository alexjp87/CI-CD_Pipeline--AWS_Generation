...
function toggleTheme() {
    ...
    const overlayContainer = document.getElementById('overlay-container');  // Added line for overlay container
    ...
    navbar.classList.toggle('dark-mode', !darkTheme);

    // Toggle dark mode for overlay text
    overlayContainer.classList.toggle('dark-mode', !darkTheme);  // Added line for overlay text toggle
}
